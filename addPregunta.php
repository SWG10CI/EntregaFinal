					...
					//Validacion del servidor
						...
						elseif (strlen($_POST['enunciado'])<10) {
							...
							echo '<span style = "padding:5px" > El enunciado debe contener al menos 10 caracteres </span>';
								...
								$sql= "INSERT INTO preguntas(email, enunciado,correcta,incorrecta1,incorrecta2,incorrecta3,complejidad,tema,img,likes,dislikes) VALUES ('$_POST[mail]','$_POST[enunciado]','$_POST[Rcor]','$_POST[RIncor1]','$_POST[RIncor2]','$_POST[RIncor3]',$_POST[complej],'$_POST[tema]', '$pic',0,0)";
